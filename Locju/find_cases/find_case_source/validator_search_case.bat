...
echo YES>yes
cd. >verdict
if %it%==0 echo ------------------------------------------------------------------------------ & echo Verdict: [92mAccepted[0m & echo ------------------------------------------------------------------------------ & echo [95mAll tests passed[0m & set /p ex=Successful search & del out.out & del ok.out & del test.in & del sol.exe & del yes & del verdict & exit
set /a am=%2 - %1 + 1
echo %am%/%2
